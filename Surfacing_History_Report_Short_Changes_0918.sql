...
;
---------------------------------------***********************************-----------------------------------
create or replace view asphalt_data_output as
select abs(t.project_end-t.project_start) as "LENGTH",t.year_ as "YEAR",
...
cast(t.As_Built_Bulk_Gravity as numeric(10,2)) as "AS BUILT BUILK GRAVITY",
...
select * from asphalt_data_output
